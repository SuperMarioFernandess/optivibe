...
plus the S-21 composite (sum of components on one grid, with the opt-in AM/FM
modulation of a sine carrier) and replay of measured CSV/WAV records and
instrument captures (TDMS/UFF/MAT/HDF5) through the data-loader registry (seam
SW-08). Each implementation is
...
from optivibe.excitation.composite import CompositeExcitationSource
...
EXCITATION_REGISTRY.register("composite")(CompositeExcitationSource)
